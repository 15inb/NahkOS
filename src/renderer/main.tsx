...
function FpsDropAnalysisPanel() {
  ...
  const [fpsStatus, setFpsStatus] = useState<{ presentMonAvailable: boolean; presentMonPath: string; lastPresentMonError?: string; externalFpsFresh: boolean } | null>(null);
  const [detected, setDetected] = useState<EntertainmentSnapshot["detected"]>([]);
